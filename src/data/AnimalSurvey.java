...
public class AnimalSurvey {
	...
	public ResultSetMetaData getRmd() {
		return rmd;
	}

	public void setRmd(ResultSetMetaData rmd) {
		this.rmd = rmd;
	}
	...
	public int getSize(int i) throws SQLException {
		size = Math.max(rmd.getColumnDisplaySize(i + 1), rmd.getColumnName(
				i + 1).length()) + 1;
		return size;
	}

	public String columnHeaders() throws SQLException {
	...
	public String recordDetails() throws SQLException {
	...
	public static void main(String[] args) {
		AnimalSurvey table = new AnimalSurvey();
		try {
			table.go();
		} catch (Throwable e) {
			System.out.println("exception thrown:");
